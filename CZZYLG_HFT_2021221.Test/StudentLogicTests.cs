...
namespace CZZYLG_HFT_2021221.Test
{
    ...
    class StudentLogicTests
    {
        ...
        public void Setup()
        {
            ...
            Classroom cr1 = new Classroom() { Id = 1, ClassroomNumber = "AAA", Teachers = new List<Teacher>() { new Teacher() { Id = 1, Name = "Tan�r1", Age = 51 } } };
            Classroom cr2 = new Classroom() { Id = 2, ClassroomNumber = "BBB", Teachers = new List<Teacher>() { new Teacher() { Id = 2, Name = "Tan�r2", Age = 60 } } };
            Classroom cr3 = new Classroom() { Id = 3, ClassroomNumber = "CCC", Teachers = new List<Teacher>() { new Teacher() { Id = 3, Name = "Tan�r3", Age = 28 } } };
            Classroom cr4 = new Classroom() { Id = 4, ClassroomNumber = "DDD", Teachers = new List<Teacher>() { new Teacher() { Id = 4, Name = "Tan�r4", Age = 44 } } };
